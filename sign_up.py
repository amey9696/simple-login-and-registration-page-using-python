...
class signup_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Sign Up System")
    ...
    #========================Variable=======================================
        ...
        title=Label(self.root,text="Sign Up System",font=("times new roman",40,"bold"),bg="yellow",fg="red",bd=10,relief=GROOVE)
        ...
        lblcpass = Label(Login_Frame, text="confirm Password", image=self.pass_icon, compound=LEFT,font=("times new roman", 20, "bold")).grid(row=3, column=0, padx=20, pady=10)
        txtcpass = Entry(Login_Frame, bd=5, textvariable=self.pass_, relief=GROOVE, font=("", 15)).grid(row=3, column=1,padx=20)

        btn_sign=Button(Login_Frame,text="Sign Up",width=15,font=("times new roman", 14, "bold"),bg="red",fg="yellow").grid(row=4,column=0,pady=10)
        btn_log = Button(Login_Frame, text="Login", width=15, font=("times new roman", 14, "bold"), bg="yellow",fg="red").grid(row=4, column=1, pady=10)
